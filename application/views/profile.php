...
<head>
    ...
    <title>Profile - <?= htmlspecialchars($user->first_name) ?></title>
    ...
    <style>
        ...
        /* Animated Background & Glassmorphism */
        @keyframes blob {
            0% {
        ...
        .bottom-sheet-modal.hidden .bottom-sheet-content {
            transform: translateY(100%);
        }
    </style>
</head>

<body class="bg-gray-50 text-navy font-display selection:bg-primary selection:text-white min-h-screen">

    <!-- Animated Background (Fixed position to stay behind everything) -->
    ...
    <div class="flex min-h-screen">
        ...
        <!-- LEFT SIDEBAR (Desktop - Visible on md+) - Copied from Home -->
        <aside class="hidden md:flex w-[72px] lg:w-[245px] flex-col glass-panel fixed inset-y-0 left-0 z-50">
            ...
            <div class="p-4 lg:hidden block flex justify-center pb-8">
                <img src="<?= base_url('assets/images/logo.png') ?>" alt="CampusConnect Logo" class="h-14 w-auto">
            </div>
            ...
            <nav class="flex-1 px-3">
                ...
                <div
                    ...
                    <span class="material-symbols-outlined text-[28px] fill-current">person</span>
                    <span class="hidden lg:block text-[16px]">Profile</span>
                </div>
            </nav>
            <?php if ($this->session->flashdata('success')): ?>
                <div class="mx-3 mb-4 p-3 bg-green-100 text-green-700 text-xs rounded-lg animate-pulse">
                    <?= $this->session->flashdata('success') ?>
                </div>
            <?php endif; ?>
            <?php if ($this->session->flashdata('error')): ?>
                <div class="mx-3 mb-4 p-3 bg-red-100 text-red-700 text-xs rounded-lg animate-pulse">
        ...
        <!-- MAIN LAYOUT -->
        <main class="flex-1 flex justify-center md:ml-[72px] lg:ml-[245px] relative">
        ...
        <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-100 pb-2 safe-area-pb">
            <div class="flex items-center justify-around h-16 px-2">
                <a href="<?= base_url('home') ?>" class="flex-1 flex justify-center text-gray-400">
                    <span class="material-symbols-outlined text-[28px]">home</span>
                </a>
                <a href="<?= base_url('search') ?>" class="flex-1 flex justify-center text-gray-400">
                    <span class="material-symbols-outlined text-[28px]">search</span>
                </a>
                <button onclick="window.location.href='<?= base_url('home') ?>?create=true'"
                    class="flex-1 flex justify-center text-gray-400 hover:text-navy transition-colors">
                    <span class="material-symbols-outlined text-[28px]">edit_square</span>
                </button>
                <button class="flex-1 flex justify-center text-gray-400 hover:text-navy transition-colors">
                    <span class="material-symbols-outlined text-[28px]">favorite</span>
                </button>
                <button class="flex-1 flex justify-center text-navy transition-colors">
                    <span class="material-symbols-outlined text-[28px] fill-current">person</span>
                </button>
            </div>
        </nav>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="flex justify-between items-center group cursor-pointer"
                            ...
                            <div
                                ...
                                <img id="edit_avatar_preview" src="<?= $my_avatar ?>"
        ...
        <div class="relative flex h-full items-end sm:items-center justify-center p-0 sm:p-4">
            ...
            <div class="w-full max-w-md bg-[#f6f7f8] rounded-t-[32px] sm:rounded-[32px] overflow-hidden shadow-2xl transition-all translate-y-full sm:translate-y-0"
                ...
                <div class="px-8 pb-10 flex flex-col items-center">
                    <!-- QR Code Card -->
                    <div
                        class="bg-white p-8 rounded-[40px] shadow-sm mb-6 flex flex-col items-center w-full max-w-[300px]">
