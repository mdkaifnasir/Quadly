...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        /* Instagram-like Sidebar Specifics */
...
<body class="bg-gray-50 text-navy font-display selection:bg-primary selection:text-white relative">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <!-- LEFT SIDEBAR (Desktop - Visible on md+) -->
        <aside
            class="hidden md:flex w-[72px] lg:w-[245px] flex-col glass-panel fixed h-full z-50 transition-all duration-300">
            ...
            <nav class="flex-1 px-3">
                <div
                    class="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer mb-2 font-bold text-navy">
                    <span class="material-symbols-outlined text-[28px] fill-current">home</span>
            ...
            <div class="px-3 pb-6 relative group">
                ...
                <div
                    ...
                    <a href="#"
                        class="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg text-sm font-medium text-navy transition-colors">
        ...
        <header class="md:hidden sticky top-0 z-50 bg-white/95 backdrop-blur-md w-full transition-all duration-300">
            <div class="flex items-center justify-center h-16 w-full relative">
                ...
                <div class="absolute right-4">
                    <!-- Optional: Group icon or something distinct -->
                </div>
            </div>
        </header>

        <!-- MAIN LAYOUT (Fluid center + Right Sidebar) -->
        <main class="flex-1 flex justify-center md:ml-[72px] lg:ml-[245px] transition-all duration-300">
        ...
        <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-100 pb-2 safe-area-pb">
            <div class="flex items-center justify-around h-16 px-2">
                <button class="flex-1 flex justify-center text-navy">
                    <span class="material-symbols-outlined text-[28px] fill-current">home</span>
                </button>
                <a href="<?= base_url('search') ?>"
                            ...
                            <div class="mt-4 flex items-center gap-4 text-gray-400">
                                <label class="cursor-pointer hover:text-navy transition-colors">
                                    ...
                                    <input type="file" name="media" id="mediaInput" class="hidden"
                                        accept="image/*,video/*" onchange="handleMediaPreview(this)">
                                </label>
