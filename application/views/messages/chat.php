    ...
    <div class="sticky bottom-0 bg-white border-t border-gray-100 p-3 kb-safe">
        ...
        <div id="mediaPreview" class="hidden mb-2 relative inline-block">
            <button onclick="clearMedia()"
                class="absolute -top-2 -right-2 bg-gray-900 text-white rounded-full p-0.5 z-10">
        ...
        <form id="messageForm" class="flex items-end gap-2 bg-gray-100 p-1.5 rounded-[24px]">
            ...
            <button type="button" onclick="document.getElementById('fileInput').click()"
                class="p-2 text-primary bg-blue-100 rounded-full shrink-0">
                <span class="material-symbols-outlined text-[20px]">attach_file</span>
            </button>
            <textarea id="messageInput" rows="1"
                class="flex-1 bg-transparent border-none focus:ring-0 p-2 text-sm max-h-32 resize-none placeholder:text-gray-400"
                placeholder="Message..."></textarea>
            <button type="submit" id="sendBtn"
                class="p-2 text-gray-400 hover:text-primary font-bold disabled:opacity-50 transition-colors">
                Send
            </button>
        </form>
    </div>
