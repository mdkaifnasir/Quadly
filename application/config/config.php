...
$root = $protocol . "://" . (isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'localhost');
...
$config['sess_cookie_name'] = 'campus_secure_session'; // Hardened name
...
$config['cookie_path'] = '/';
$config['cookie_secure'] = FALSE; // Keep FALSE for local dev (http)
$config['cookie_httponly'] = TRUE; // Prevent JS access to cookies
...
$config['csrf_regenerate'] = FALSE; // Disabled for easier AJAX handling
$config['csrf_exclude_uris'] = array('auth/validate_qr_code');
